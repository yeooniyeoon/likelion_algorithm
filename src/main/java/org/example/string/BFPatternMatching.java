...
public class BFPatternMatching {
    public void solution() throws IOException {
        ...
        // TODO tarIdx 전체 길이보다 적을 동안에 반복한다.
        // TODO 존재하는지만 검사하면 된다 했을 경우 patIdx가 pattern.length() 보다 작을 동안 반복.
        ...
        // TODO 못찾으면 System.out.println("404 non found");
        else {
    ...
    public static void main(String[] args) throws IOException {
        BFPatternMatching bfp = new BFPatternMatching();
        bfp.solution();
    }
}
